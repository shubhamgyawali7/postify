    ...
    <main className="min-h-[calc(100vh-56px)] bg-[#f8f9fc] p-4 sm:p-6 lg:p-8">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-slate-500">Make changes to your post below.</p>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              {showImage && !preview && (
                <div className="mb-3">
                  <img src={existingImage} alt="Current" className="w-full h-52 object-cover rounded-xl border border-slate-200" />
                  <p className="text-xs text-slate-400 mt-1.5">Leave unchanged or upload a new image</p>
                </div>
              )}
              {preview ? (
            ...
            <div className="flex justify-end gap-3 pt-2">
              <button
                type="button"
                onClick={() => navigate(postDetailsPath(id))}
